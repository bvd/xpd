...
<html>
    <head>
        ...
        <script type="text/javascript">var whatToDoBart = "<?php if(isset($_GET["check"])){ echo $_GET["check"]; } else { echo "none";} ?>";</script>
        <script type="text/javascript">var fakeItBart = "<?php if(isset($_GET["fake"])){ echo $_GET["fake"]; } else { echo "none";} ?>";</script>
		<!-- JSON -->
